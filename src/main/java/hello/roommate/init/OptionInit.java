...
import hello.roommate.recommendation.domain.enums.*;
    ...
    public void createOption() {
        if (optionRepository.count() == 0) { // 중복 삽입 방지
            List<Option> options = Arrays.asList(
                    ...
                    //나이
                    new Option(Category.AGE, Age.TWENTY.name()),
                    new Option(Category.AGE, Age.TWENTY_ONE.name()),
                    new Option(Category.AGE, Age.TWENTY_TWO.name()),
                    new Option(Category.AGE, Age.TWENTY_THREE.name()),
                    new Option(Category.AGE, Age.TWENTY_FOUR.name()),
                    new Option(Category.AGE, Age.TWENTY_FIVE.name()),
                    new Option(Category.AGE, Age.TWENTY_SIX.name()),
                    new Option(Category.AGE, Age.TWENTY_SEVEN.name()),
                    new Option(Category.AGE, Age.TWENTY_EIGHT.name())
            );
