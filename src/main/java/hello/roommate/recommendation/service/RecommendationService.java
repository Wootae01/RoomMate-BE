...
public class RecommendationService {
	...
	public void update(String member1Id, String member2Id) {
		...
		double cal = calCosineSimilarity(recommendation.getMember1().getLifeStyle(),
			recommendation.getMember2().getLifeStyle());
	...
	private double calCosineSimilarity(LifeStyle a, LifeStyle b) {
		int[] vectorA = {a.getBedTime(), a.getWakeupTime(), a.getSleepHabit(), a.getCleaning(), a.getAircon(),
			a.getHeater(), a.getNoise(), a.getSmoking(), a.getScent(), a.getEating(), a.getRelationship(),
			a.getDrinking(), a.getAge()};

		int[] vectorB = {b.getBedTime(), b.getWakeupTime(), b.getSleepHabit(), b.getCleaning(), b.getAircon(),
			b.getHeater(), b.getNoise(), b.getSmoking(), b.getScent(), b.getEating(), b.getRelationship(),
			b.getDrinking(), b.getAge()};
