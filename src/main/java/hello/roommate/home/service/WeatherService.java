...
import static hello.roommate.home.external.weather.WeatherResponse.Item;
...
public class WeatherService {
    ...
    public void update(Weather dto) {
        Weather weather = weatherRepository.findByFcstDateAndFcstTime(dto.getFcstDate(), dto.getFcstTime())
                .orElseThrow();
